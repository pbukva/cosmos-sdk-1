...
type InflationCalculationFn func(ctx sdk.Context, minter Minter, params Params) sdk.Dec

// DefaultInflationCalculationFn is the default function used to calculate inflation.
func DefaultInflationCalculationFn(_ sdk.Context, minter Minter, params Params) math.LegacyDec {
